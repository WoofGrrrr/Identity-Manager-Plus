...
Use this API to access files in the user profile folder. Until Mozilla has made a
final decision about including the [Chrome FileSystem API](https://web.dev/file-system-access/),
...
Add the [FileSystemExp API](https://github.com/WoofGrrrr/file-system-broker/tree/main/apis/BrokerFileSystemExp) to your add-on.
...
Where:
  ...
  + \<extension-id\> is the Extension ID of the extension using the APO
